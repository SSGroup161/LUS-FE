...
export default function TermsConditions() {
    ...
    const description =
        "Selamat datang di situs-web yang didedikasikan untuk Level Up Style dan dapat diakses melalui URL www.levelupstyle.id Mohon dibaca secara seksama Ketentuan Penggunaan situs-web ini. Dengan mengakses situs ini artinya Anda menerima Ketentuan Penggunaan situs-web tanpa penolakan.";
    const canonicalUrl = "https://www.levelupstyle.id/terms-conditions";
        ...
        <>
            ...
            <div className="w-full flex flex-col justify-start items-center bg-white">
                <div className="w-80 md:w-[40rem] my-20 md:my-44">
                    ...
                    >
                        {" "}
                        Welcome to the website dedicated to Level Up Style and
                        can be accessed via URL{" "}
                        <a
                            href="https://www.levelupstyle.id"
                        ...
                        Level Up Indonesia Success, a company that has an office
                        on Jl. K.H. Wahid Hasyim No.161, RT.1/RW.5, Kb. Kacang,
                        Tanah Abang District, Central Jakarta City, Special
                        Capital Region of Jakarta 10240, registered at Ministry
                        of Law and Human Rights of the Republic Indonesia, with
                        number AHU-0034331.AH.01.01.TAHUN 2024, email address:{" "}
                        <a
